...
define('OW_URL_HOME', 'https://develop.chamial.com/');

define('OW_DB_HOST', 'localhost');
define('OW_DB_PORT', null);
define('OW_DB_USER', 'chamdev_develop');
define('OW_DB_PASSWORD', 'develop');
define('OW_DB_NAME', 'chamdev_develop');

define('OW_DB_PREFIX', 'ch_');
...
define('OW_PASSWORD_SALT', 'G1mOLurEMU51ZUSe');
